...
| Pattern | Description | Status | Practices |
|:-------:|:----------- |:------:|:---------:|
| [Abstract Factory](/creational/abstract_factory.md) | Provides an interface for creating families of releated objects | ✘ | ✘ |
| [Builder](/creational/builder.md) | Builds a complex object using simple objects | ✔ | [Builder](/practices/builder/main.go) |
| [Factory Method](/creational/factory.md) | Defers instantiation of an object to a specialized function for creating instances | ✔ | [Factory](/practices/factory/main.go) |
